...
//           <li key={index}>
//             {" "}
//             {/* It's better to use a unique id if available */}
//             <strong>Organization:</strong> {event.OrganizationName}
//             <br />
//             <strong>Starts On:</strong> {new Date(event.startsOn).toLocaleString()}
//             <br />
//             <strong>Ends On:</strong> {new Date(event.endsOn).toLocaleString()}
//             <br />
